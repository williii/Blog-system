<?php
	class Users extends CI_Controller {
		public function register() {
			...
			$this->form_validation->set_rules('username','Username','callback_check_username_exists|required');
			$this->form_validation->set_rules('email','Email','callback_check_email_exists|required');
